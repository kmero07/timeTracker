...
CREATE TABLE `worktime` (
  `idworkTime` int NOT NULL,
  `date` date NOT NULL,
  `hours` double NOT NULL,
  `user` int NOT NULL,
  `project` int NOT NULL,
  PRIMARY KEY (`idworkTime`),
  UNIQUE KEY `idworkTime_UNIQUE` (`idworkTime`),
  KEY `Project_idx` (`project`),
  CONSTRAINT `Project` FOREIGN KEY (`project`) REFERENCES `project` (`idproject`)
...
-- Dump completed on 2023-01-03 11:14:44
